...
import { Clock, Package, User, Filter, AlertTriangle } from "lucide-react";
...
export default function ClientOrdersPage() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await api.get("/api/orders/client");
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600">Track and manage your service orders</p>
          </div>
          <button
        ...
        {filteredOrders.length === 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <p className="text-slate-600 mb-6">
              {statusFilter === "all" 
                ? "Start by browsing services and placing your first order"
